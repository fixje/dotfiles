...
fallbackwallpaper = sharedthemes .. "/default/background.png"
...
elseif awful.util.file_readable(wallpaper2) then
	...
	theme.wallpaper_cmd = { "awsetbg " .. fallbackwallpaper }
end
--}}}
...
theme.mouse_finder_radius = 150
theme.mouse_finder_timeout = 1
theme.mouse_finder_animate_timeout = 0.01
...
theme.awesome_icon           = icons .. "/fox.png"
